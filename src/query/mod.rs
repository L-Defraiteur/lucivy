...
pub use self::phrase_query::regex_continuation_query::{RegexContinuationQuery, ContinuationMode, CachedRegexResult, highlights_to_doc_tf, run_regex_prescan, run_fuzzy_prescan};
...
pub use self::query::{EnableScoring, Query, QueryClone, RegexPrescanParam, SfxPrescanParam};
