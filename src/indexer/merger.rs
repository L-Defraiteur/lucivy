...
impl IndexMerger {
    ...
    pub fn write(&self, mut serializer: SegmentSerializer) -> crate::Result<u32> {
        ...
        // SFX merge is handled by sfx_dag.rs (WriteSfxNode) in the merge DAG.
        // IndexMerger::write() does not merge SFX files — it only merges
        // postings, stored fields, fieldnorms, and fast fields.
    ...
    // merge_sfx_deferred and merge_sfx_legacy removed — SFX merge is now
    // handled exclusively by sfx_dag.rs (WriteSfxNode) in the merge DAG.
    // See docs/1-avril-16h46/02-chemins-indexation-complet.md for details.
}
#[cfg(test)]
mod tests {
