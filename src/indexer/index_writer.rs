...
// worker_loop removed — replaced by IndexerActor (see indexer_actor.rs)
...
impl<D: Document> IndexWriter<D> {
    ...
    pub fn wait_merging_threads(self) -> crate::Result<()> {
    ...
    #[allow(private_interfaces)] // EventReceiver is pub(crate) but this API is used externally.
    ...
    pub fn merge(&mut self, segment_ids: &[SegmentId]) -> crate::Result<Option<SegmentMeta>> {
    ...
    fn test_set_merge_policy() {
        ...
        assert_eq!(
            ...
            "LogMergePolicy { min_num_segments: 8, max_docs_before_merge: 10000000, \
             max_merged_docs: None, min_layer_size: 10000, level_log_size: 0.75, \
