...
mod ffi {
    ...
    extern "Rust" {
        ...
        // Lifecycle
        fn lucivy_create(path: &str, fields_json: &str, stemmer: &str) -> Result<Box<LucivyIndex>>;
...
fn lucivy_create(path: &str, fields_json: &str, stemmer: &str) -> Result<Box<LucivyIndex>, String> {
