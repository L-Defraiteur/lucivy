...
|---|---|---|---|---|---|---|---|---|
| `mutex_lock` | substring | 5 202 | **5 202** OK | 21 070 | 13 ms | 29 ms | **5 202** · 8 ms (+85 ms with highlights on 200) | 5 229 · 108 ms |
| `mutex_lock` | separators relaxed | 5 862 | **5 862** OK | 23 067 | 12 ms | 38 ms | — | — |
| `spin_lock` | substring | 6 527 | **6 527** OK | 34 436 | 12 ms | 32 ms | **6 527** · 6 ms (+95 ms with highlights on 200) | 6 563 · 118 ms |
| `sched` | whole word | 5 246 | **5 246** OK | 27 341 | 20 ms | 54 ms | 1 724 · 0 ms (+41 ms with highlights on 200) | 5 260 · 0 ms |
| `sched` | substring | 9 214 | **9 214** OK | 52 228 | 12 ms | 38 ms | 9 181 · 2 ms (+79 ms with highlights on 200) | 9 238 · 150 ms |
| `printk` | start of token | 4 446 | **4 446** OK | 24 702 | 14 ms | 37 ms | 3 164 · 2 ms (+77 ms with highlights on 200) | 4 399 · 0 ms |
| `schdule` | fuzzy, 1 edit | 5 148 | **5 148** OK | 18 549 | 51 ms | 202 ms | 1 531 · 2 ms (+53 ms with highlights on 200) | 3 721 · 4 ms |
| `regsiter` | fuzzy, 2 edits | 34 833 | **34 833** OK | 265 247 | 860 ms | 382 ms | 21 165 · 13 ms (+216 ms with highlights on 200) | 29 438 · 16 ms |
| `spin_lock_[a-z]+` | regex | 5 471 | **5 471** OK | 24 156 | 237 ms | 22 ms | **5 471** · 438 ms (+726 ms with highlights on 200) | 0 · 0 ms |
...
|---|---|---|---|---|
| `spin_lock`, separators strict | 6 527 | **6 527** OK, 34 436 spans, 12 ms | **6 527** (spin_lock, separators strict, 0 ms) | 6 563 (spin_lock (substring), 118 ms)<br>6 563 (spin_lock (trigrams, verified, strict), 119 ms) |
| `spin_lock`, separators relaxed — also `spin lock`, `spin-lock`, `spinlock` | 9 545 | **9 545** OK, 54 680 spans, 41 ms | 6 524 (spin_lock, separators relaxed (spin_lock, spin lock, spin-lock, spinlock), 4 ms)<br>170 ("spin lock" as a phrase, standard analyzer, 0 ms) | 6 608 (spinlock (trigrams, verified; must find spin_lock too), 114 ms)<br>6 594 ("spin lock" (phrase, default tokenizer), 1 ms) |
| `spinlokc`, two edits, across the token boundary | 10 117 | **10 117** OK, 56 836 spans, 171 ms | 3 534 (spinlokc, two edits, across the token boundary, 10 ms) | 6 585 (spinlokc (fuzzy, 2 edits, across the boundary), 17 ms) |
...
| `retur -ENOMEM`, a fuzzy phrase (one edit: a letter missing) | 14 377 | **14 377** OK, 31 937 spans, 40 ms | 14 374 (retur -ENOMEM (fuzzy phrase: span_near of a fuzzy span and a term), 7 ms) | — |
...
| Elasticsearch, `highlight` on the top 200 | 5 202 | 2 485 (as marked by the engine) | 200 | 99 ms + 0.3 ms to parse 2.9 MB of markup |
