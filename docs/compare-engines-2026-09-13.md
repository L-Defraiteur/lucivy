...
|---|---|---|---|---|---|---|---|---|
| `mutex_lock` | substring | 5 202 | **5 202** OK | 21 070 | 13 ms | 29 ms | **5 202** · 0 ms (+98 ms with highlights on 200) | 5 229 · 108 ms |
| `mutex_lock` | separators relaxed | 5 862 | **5 862** OK | 23 067 | 12 ms | 38 ms | — | — |
| `spin_lock` | substring | 6 527 | **6 527** OK | 34 436 | 12 ms | 32 ms | **6 527** · 0 ms (+81 ms with highlights on 200) | 6 563 · 118 ms |
| `sched` | whole word | 5 246 | **5 246** OK | 27 341 | 20 ms | 54 ms | 1 724 · 5 ms (+33 ms with highlights on 200) | 5 260 · 0 ms |
| `sched` | substring | 9 214 | **9 214** OK | 52 228 | 12 ms | 38 ms | 9 181 · 0 ms (+63 ms with highlights on 200) | 9 238 · 150 ms |
| `printk` | start of token | 4 446 | **4 446** OK | 24 702 | 14 ms | 37 ms | 3 164 · 0 ms (+54 ms with highlights on 200) | 4 399 · 0 ms |
| `schdule` | fuzzy, 1 edit | 5 148 | **5 148** OK | 18 549 | 51 ms | 202 ms | 1 531 · 0 ms (+55 ms with highlights on 200) | 3 721 · 4 ms |
| `regsiter` | fuzzy, 2 edits | 34 833 | **34 833** OK | 265 247 | 860 ms | 382 ms | 21 165 · 0 ms (+195 ms with highlights on 200) | 29 438 · 16 ms |
| `spin_lock_[a-z]+` | regex | 5 471 | **5 471** OK | 24 156 | 237 ms | 22 ms | **5 471** · 1 ms (+669 ms with highlights on 200) | 0 · 0 ms |
...
|---|---|---|---|---|
| `spin_lock`, separators strict | 6 527 | **6 527** OK, 34 436 spans, 12 ms | **6 527** (spin_lock, separators strict, 0 ms +81 ms with highlights on 200) | 6 563 (spin_lock (substring), 118 ms)<br>6 563 (spin_lock (trigrams, verified, strict), 119 ms) |
| `spin_lock`, separators relaxed — also `spin lock`, `spin-lock`, `spinlock` | 9 545 | **9 545** OK, 54 680 spans, 41 ms | 6 524 (spin_lock, separators relaxed (spin_lock, spin lock, spin-lock, spinlock), 0 ms +54 ms with highlights on 200)<br>170 ("spin lock" as a phrase, standard analyzer, 0 ms +57 ms with highlights on 170) | 6 608 (spinlock (trigrams, verified; must find spin_lock too), 114 ms)<br>6 594 ("spin lock" (phrase, default tokenizer), 1 ms) |
| `spinlokc`, two edits, across the token boundary | 10 117 | **10 117** OK, 56 836 spans, 171 ms | 3 534 (spinlokc, two edits, across the token boundary, 0 ms +187 ms with highlights on 200) | 6 585 (spinlokc (fuzzy, 2 edits, across the boundary), 17 ms) |
| `spin_lock_[a-z]+`, a regex | 5 471 | **5 471** OK, 24 156 spans, 237 ms | **5 471** (spin_lock_[a-z]+ (regex, wildcard field, case folded), 1 ms +673 ms with highlights on 200) | 0 (spin_lock_[a-z]+ (regex, terms), 0 ms) |
| `ude`, three characters | 74 500 | **74 500** OK, 478 423 spans, 106 ms | 68 561 (ude (three characters), 0 ms +28 ms with highlights on 200) | 74 679 (ude (three characters), 0 ms) |
| `de`, two characters | 100 166 | **100 166** OK, 7 929 772 spans, 587 ms | 0 (de (two characters), 0 ms +0 ms with highlights on 0) | 0 (de (two characters), 0 ms) |
| `retur -ENOMEM`, a fuzzy phrase (one edit: a letter missing) | 14 377 | **14 377** OK, 31 937 spans, 40 ms | 14 374 (retur -ENOMEM (fuzzy phrase: span_near of a fuzzy span and a term), 0 ms +118 ms with highlights on 200) | — |
...
| Elasticsearch, `highlight` on the top 200 | 5 202 | 2 485 (as marked by the engine) | 200 | 85 ms + 0.4 ms to parse 2.9 MB of markup |
