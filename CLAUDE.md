...
- Temps d'indexation de référence (noyau, index neufs) : **dictionnaire 65,6 s le 13 septembre** (97,4 le matin même : plafond de paires 64 + cache partagé vérifié, `docs/13-09-2026/07`) ; avant : v3 56 s, dictionnaire 131 s le 5 au soir →
