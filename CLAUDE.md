...
- Temps d'indexation de référence (noyau, index neufs) : **dictionnaire 57,2 s le 13 septembre au soir** (97,4 le matin même : plafond de paires 64, cache partagé vérifié, compaction et replis en pipeline sans allocation par clé — 10,5 → 3,0 s ; `docs/13-09-2026/07`) ; avant : v3 56 s, dictionnaire 131 s le 5 au soir →
